    ...
    <div className="p-[24px] flex flex-col gap-[24px] w-full">
      ...
      <div className="w-full bg-white border border-[#C2C6D4] rounded-[16px] flex flex-col overflow-hidden shadow-sm">
        ...
        <div className="flex items-center h-[61px] border-b border-[#C2C6D4] px-[24px]">
          ...
          <button className="h-full flex items-center gap-2 text-[#555F6B] font-bold text-[14px] border-b-[3px] border-transparent hover:text-slate-800 transition-colors px-[8px]">
            <Briefcase size={18} /> Payroll (Employees)
          </button>
        </div>
